class PagesController < ApplicationController
  ...
  def westcoastlines
    @line_a = WestCoastLine.order(name: 'ASC').where(letter: 'A')
    @line_b = WestCoastLine.order(name: 'ASC').where(letter: 'B')
    @line_c = WestCoastLine.order(name: 'ASC').where(letter: 'C')
    @line_d = WestCoastLine.order(name: 'ASC').where(letter: 'D')
    @line_e = WestCoastLine.order(name: 'ASC').where(letter: 'E')
    @line_f = WestCoastLine.order(name: 'ASC').where(letter: 'F')
    @line_g = WestCoastLine.order(name: 'ASC').where(letter: 'G')
    @line_h = WestCoastLine.order(name: 'ASC').where(letter: 'H')
    @line_i = WestCoastLine.order(name: 'ASC').where(letter: 'I')
    @line_j = WestCoastLine.order(name: 'ASC').where(letter: 'J')
    @line_k = WestCoastLine.order(name: 'ASC').where(letter: 'K')
    @line_l = WestCoastLine.order(name: 'ASC').where(letter: 'L')
    @line_m = WestCoastLine.order(name: 'ASC').where(letter: 'M')
    @line_n = WestCoastLine.order(name: 'ASC').where(letter: 'N')
    @line_o = WestCoastLine.order(name: 'ASC').where(letter: 'O')
    @line_p = WestCoastLine.order(name: 'ASC').where(letter: 'P')
    @line_q = WestCoastLine.order(name: 'ASC').where(letter: 'Q')
    @line_r = WestCoastLine.order(name: 'ASC').where(letter: 'R')
    @line_s = WestCoastLine.order(name: 'ASC').where(letter: 'S')
    @line_t = WestCoastLine.order(name: 'ASC').where(letter: 'T')
    @line_u = WestCoastLine.order(name: 'ASC').where(letter: 'U')
    @line_v = WestCoastLine.order(name: 'ASC').where(letter: 'V')
    @line_w = WestCoastLine.order(name: 'ASC').where(letter: 'W')
    @line_x = WestCoastLine.order(name: 'ASC').where(letter: 'X')
    @line_y = WestCoastLine.order(name: 'ASC').where(letter: 'Y')
    @line_z = WestCoastLine.order(name: 'ASC').where(letter: 'Z')
  end
